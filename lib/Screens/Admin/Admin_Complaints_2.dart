          ...
          child: ListView(
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Container(
                      child: Text(
                        widget.adminComplaint.complaintNumber,
              ...
              Container(
                ...
                child: Text(
                  widget.adminComplaint.complaintDetail,
                  textAlign: TextAlign.left,
                  style: headlineSmall,
                ),
              ),
              ...
              Container(
                ...
                child: Text(
                  widget.adminComplaint.userName,
                  style: textHint,
                ),
              ),
              Container(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(color: blk, width: 1.0)),
                child: Text(
                  widget.adminComplaint.userNumber,
                  style: textHint,
                ),
              ),
              Container(
